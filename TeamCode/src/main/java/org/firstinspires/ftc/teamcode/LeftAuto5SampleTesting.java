...
import org.firstinspires.ftc.teamcode.Auto.samplePickUp;
...
public class LeftAuto5SampleTesting extends LinearOpMode {
...
//        ElapsedTime outtakeTimer = new ElapsedTime();
        ...
        TrajectoryActionBuilder park = drive.actionBuilder(new Pose2d(-52, -52, Math.toRadians(45)))
                .splineToLinearHeading(new Pose2d(-17, -5, Math.toRadians(180)), Math.toRadians(-10), new TranslationalVelConstraint(100), new ProfileAccelConstraint(-100, 100));
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("At the Sub Vector2d", drive.pose.position);
            telemetry.addData("At the Sub Heading", drive.pose.heading);
            telemetry.update();
            ...
            TrajectoryActionBuilder scoreSub1 = drive.actionBuilder(drive.pose)
                    .setTangent(85)
                    .splineToLinearHeading(new Pose2d(-53, -53, Math.toRadians(45)), Math.toRadians(260), new TranslationalVelConstraint(80), new ProfileAccelConstraint(-80, 80));
