...
public class RightAuto0_3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence pushFirstSamples = drive.trajectorySequenceBuilder(new Pose2d(9, -35, Math.toRadians(270)))
...
//                .splineToLinearHeading(new Pose2d(56, -50, Math.toRadians(90)), Math.toRadians(40))
        ...
        TrajectorySequence collectSpecimen2 = drive.trajectorySequenceBuilder(new Pose2d(43, -50, Math.toRadians(90)))
                .lineToConstantHeading(new Vector2d(37, -50))
                .lineToConstantHeading(new Vector2d(37, -57))
                .build();

        TrajectorySequence scoreSecondSpecimen = drive.trajectorySequenceBuilder(new Pose2d(37, -57, Math.toRadians(90)))
                .splineToLinearHeading(new Pose2d(-1, -35, Math.toRadians(270)), Math.toRadians(90))
                .build();

        TrajectorySequence scoreThirdSpecimen = drive.trajectorySequenceBuilder(new Pose2d(37, -57, Math.toRadians(90)))
                .splineToLinearHeading(new Pose2d(-5, -35, Math.toRadians(270)), Math.toRadians(90))
                .build();

        TrajectorySequence collectNextSpecimen = drive.trajectorySequenceBuilder(new Pose2d(9, -35, Math.toRadians(270)))
                .lineToLinearHeading(new Pose2d(37, -50, Math.toRadians(90)))
                .build();

        TrajectorySequence driveIntoSpecimen = drive.trajectorySequenceBuilder(new Pose2d(37, -50, Math.toRadians(270)))
        ...
        drive.followTrajectorySequence(pushFirstSamples);

        //scoring 2nd specimen

        Robot.outtake.specimenReceivePosition(outtakeClaw, outtakeWrist, outtakeArm);

        drive.followTrajectorySequence(collectSpecimen2);
        ...
        drive.followTrajectorySequence(scoreSecondSpecimen);
        ...
        drive.followTrajectorySequence(collectNextSpecimen);
