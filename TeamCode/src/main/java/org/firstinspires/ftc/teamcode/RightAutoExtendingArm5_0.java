...
public class RightAutoExtendingArm5_0 extends LinearOpMode {
...
//        ElapsedTime outtakeTimer = new ElapsedTime();
        ...
        TrajectoryActionBuilder scorePreload = drive.actionBuilder(startPose)
                .lineToY(-31, new TranslationalVelConstraint(70), new ProfileAccelConstraint(-10, 50));
        ...
        TrajectoryActionBuilder scoreSpecimen2 = drive.actionBuilder(new Pose2d(47, -60, Math.toRadians(90)))
                .setTangent(15)
                .splineToConstantHeading(new Vector2d(-1, -25), Math.toRadians(90), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-30, 50));

        TrajectoryActionBuilder collectSpecimen3 = drive.actionBuilder(new Pose2d(-2, -29, Math.toRadians(90)))
        ...
        TrajectoryActionBuilder scoreSpecimen3 = drive.actionBuilder(new Pose2d(47, -62, Math.toRadians(90)))
                .setTangent(15)
        ...
        TrajectoryActionBuilder collectSpecimen4 = drive.actionBuilder(new Pose2d(-5, -27, Math.toRadians(90)))
                .splineToConstantHeading(new Vector2d(47, -52), Math.toRadians(0), new TranslationalVelConstraint(60), new ProfileAccelConstraint(-40, 40))
                .setTangent(Math.toRadians(90))
                .lineToY(-62);

        TrajectoryActionBuilder scoreSpecimen4 = drive.actionBuilder(new Pose2d(47, -52, Math.toRadians(90)))
                .setTangent(15)
                .splineToConstantHeading(new Vector2d(-8, -27), Math.toRadians(90), new TranslationalVelConstraint(50), new ProfileAccelConstraint(-30, 50));
        ...
        Actions.runBlocking(new SequentialAction(
                ...
                new ParallelAction(
                        new setLinkage(linkage1, 0.1, linkage2, 0.9),
                        new closeClaw(outtakeClaw)
                ),
                new ParallelAction(
                        new setOuttakeSlidesPatient(slideMotor_back, slideMotor_front, slideMotor_up, SPECIMEN_SCORE_TICKS, 1.0),
                        new scoreSpecimen(outtakeArm, outtakeArm2, outtakeWrist, outtakeClaw),
                        new setLinkage(linkage1, 0.02, linkage2, 0.98),
    ...
    public class setLinkage implements Action{
        Servo linkage1;
        double l1;
        Servo linkage2;
        double l2;

        public setLinkage(Servo linkage1, double l1, Servo linkage2, double l2){
        ...
        public boolean run(@NonNull TelemetryPacket telemetryPacket) {
            ...
            linkage1.setPosition(l1);
            linkage2.setPosition(l2);
