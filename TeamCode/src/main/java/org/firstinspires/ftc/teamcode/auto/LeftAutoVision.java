...
public class LeftAutoVision extends LinearOpMode {
...
//                .splineToLinearHeading(new Pose2d(-17, -5, Math.toRadians(180)), Math.toRadians(-10));
        ...
        while (opModeIsActive()) {
            ...
            TrajectoryActionBuilder collectSample1 = drive.actionBuilder(drive.pose)
                    .strafeToLinearHeading(new Vector2d(-52, -37), Math.toRadians(65));
            ...
            TrajectoryActionBuilder scoreSample1 = drive.actionBuilder(drive.pose)
                    .splineToLinearHeading(new Pose2d(-52, -52, Math.toRadians(45)), Math.toRadians(90));
            ...
            TrajectoryActionBuilder collectSample2 = drive.actionBuilder(drive.pose)
                    .strafeToLinearHeading(new Vector2d(-57.5, -37), Math.toRadians(98));
            ...
            TrajectoryActionBuilder scoreSample2 = drive.actionBuilder(drive.pose)
                    .splineToLinearHeading(new Pose2d(-52, -52, Math.toRadians(45)), Math.toRadians(90));
            ...
            TrajectoryActionBuilder collectSample3 = drive.actionBuilder(drive.pose)
                    .strafeToLinearHeading(new Vector2d(-57, -33), Math.toRadians(140));
            ...
            TrajectoryActionBuilder scoreSample3 = drive.actionBuilder(drive.pose)
                    .splineToLinearHeading(new Pose2d(-52, -52, Math.toRadians(45)), Math.toRadians(90));
    ...
    private void alignAndIntake(ElapsedTime delay, DcMotorEx leftFront, DcMotorEx leftBack,
        ...
        intakeArmRight.setPosition(0.66);//increase to lower arm detection position
        delay.reset();
