...
public class shortarmtestauto extends LinearOpMode {
...
//        ElapsedTime outtakeTimer = new ElapsedTime();
        ...
        TrajectoryActionBuilder scorePreload = drive.actionBuilder(startPose)
                .lineToY(-31, new TranslationalVelConstraint(80)/*Originally 70*/, new ProfileAccelConstraint(-80, 80));
...
//                .strafeTo(new Vector2d(6, -28), new TranslationalVelConstraint(120), new ProfileAccelConstraint(-50, 100));
...
//                .splineToLinearHeading(new Pose2d(50, -55, Math.toRadians(90)), Math.toRadians(90), new TranslationalVelConstraint(70), new ProfileAccelConstraint(-70, 70));
        ...
        TrajectoryActionBuilder collectSpecimen1 = drive.actionBuilder(drive.pose)
                .lineToY(-61/*originally-62*/, new TranslationalVelConstraint(30), new ProfileAccelConstraint(-30, 30));
        ...
        TrajectoryActionBuilder park = drive.actionBuilder(drive.pose)
                .splineToLinearHeading(new Pose2d(40, -60, Math.toRadians(90)), Math.toRadians(90), new TranslationalVelConstraint(70), new ProfileAccelConstraint(-70, 70));
